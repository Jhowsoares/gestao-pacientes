...
![landingpage](imagens/landing_page/landing_page-footer.png)

**Login, cadastro e redefinição de senha**  
![tela-login](imagens/login/login.png)  
![tela-login](imagens/login/login-cadastro.png)  
![tela-login](imagens/login/login-senha.png)

**Tela principal do sistema**  
![tela-home](imagens/home/home.png)

**Gerenciamento de pacientes**  
![tela-pacientes](imagens/pacientes/pacientes-view.png)  
![tela-pacientes](imagens/pacientes/pacientes-create.png)

**Administração de tarefas**  
![tela-tarefas](imagens/tarefas/task-view.png)  
![tela-tarefas](imagens/tarefas/task-create.png)
...
Você pode visualizar uma versão demonstrativa (por enquanto não é a mais atual) [aqui](https://auroramoradadosaber.pythonanywhere.com/)
